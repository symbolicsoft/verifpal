...
var coqHeader = strings.Join([]string{
	...
	"",
	"Fixpoint attacker_constructor (type: attacker_type)",
	"        (knowledge: attacker_knowledge) : attacker := attacker_c type knowledge.",
	"",
	"Fixpoint search_attacker (a: attacker) (cm: constant_meta) : bool :=",
	"  match a with",
	"    | attacker_invalid _ => false",
	"    | attacker_c _ ak => search_constant_meta_by_name_ak ak (",
	...
	"  match a with",
	"    | attacker_invalid _ => false",
	"    | attacker_c _ ak => search_constant_meta_by_name_ak ak name",
	"   end.",
	"",
	...
	"    | attacker_c type ak => match m with ",
