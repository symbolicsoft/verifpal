...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
	VERIFPWD=$(pwd)
	VERIFPALOS="linux"
	VERIFPALDL="https://github.com/SymbolicSoft/verifpal/releases/latest/download/verifpal_linux.zip"
elif [[ "$OSTYPE" == "darwin"* ]]; then
	VERIFPALWD=$(pwd)
	VERIFPALOS="darwin"
	VERIFPALDL="https://github.com/SymbolicSoft/verifpal/releases/latest/download/verifpal_macos.zip"
else
	/bin/echo ""
